...
public class PresentationController {
    ...
    @PostMapping("/{id}/generate") public ResponseEntity<Void> generate(@PathVariable String id){service.get(id);service.generate(id);return ResponseEntity.accepted().build();}
